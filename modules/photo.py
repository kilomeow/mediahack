...
npc.Magpie.say("уже"),
npc.Magpie.say("**Пост с угрозами**"),
...
npc.Owl.say("Кролик, бери лапы в лапы и беги к нотариусу. Тебе нужен *«Акт осмотра страницы в сети «Интернет»* двух этих скриншотов с угрозами*.* Сделаешь его, потом бегом в полицию, писать *заявление о преступлении*. Только сделать всё надо быстро. Полиция почти не занимается подобными делами, но здесь на лицо угроза физической расправы. Жалобу в телеграм я уже отправил, хотя это может ни на что не повлиять."),
...
npc.Squirrel.say("**ГОЛОСОВАНИЕ: Сообщаем/Не сообщаем**"),
