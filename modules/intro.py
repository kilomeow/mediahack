...
content = StoryMap(
    entry=[
        ...
        npc.Squirrel.info("У вас будет всего 10 минут на задание, и время пойдет после того как вы нажмете Приступить. Будьте на чеку!", button_text="Приступить"),
        npc.Squirrel.task(text=f"Вот [сообщение]({docs['fox_note']}). Итак, какие слова выдают местоположение или личные данные Кролика? Фрагментов всего 4 — напишите их "
                         "сюда, а мы уберём их из письма. Жду ваших вариантов! Подсказка: удалить нужно всего 4 фрагмента. Каких?",
                    minutes=10,
