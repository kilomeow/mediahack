...
content = StoryMap(
    entry = [
        ...
        npc.Squirrel.say("Вам не нужно менять его структуру, но если там содержатся вещи, которые мы не можем публиковать, то просто удалите или замените их)"),
        ...
        npc.Squirrel.ask("Вот примерный список! Нажимайте на кнопку, и мы немедленно приступим к работе!", [("Социальные сети, мессенджеры, пароли", "social_media"), ("Фишинг, VPN и почты", "fishing")], Var.module),
        Proceed('social')
    ],
