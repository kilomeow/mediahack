...
content = StoryMap(
    entry=[
        ...
        мигрантов у себя под окнами. Скажите вашим пушистым друзьям, чтобы сворачивали свои палатки и шли в другое 
...
Прекращайте этот балаган немедленно. """),
        ...
        гости я слышал что вы любите вские горячие новости а будет очень горячо.... 
...
З.Ы. Передавай обгоревшим уродам привет"""),
    ...
    photo=[
        ...
        адреса установлены, их любимая газётенка даже не думала их спасать. Мы настоятельно рекомендуем всем, 
    ...
    game_break=[
        npc.Squirrel.ask(
            "Самое время взять небольшую паузу! Отдохните, налейте себе чай, дайте себе перевести дыхание. "
    ...
    vzlom=[
        ...
        npc.Rabbit.info(
            ...
            "по правилам, поэтомы мы вынуждены прекратить нашу деятельность."),
        ...
        npc.Squirrel.ask(
            "Подумайте хорошенько перед тем как принимать решение! У вас только одно нажатие на кнопку, обсудите ваши "
            "идеи в чате.",
            [("Кролик взломан", "kick"), ("Кролик не взломан", "not_kick")], Var.kick_rabbit),
...
Чтобы избежать повторных случаев взлома, мы удаляем все наши аккаунты в соцсетях. Связаться с нами все еще можно по 
горячей линии. 

Мы считаем, что взломы связаны с угрозами от неизвестных, которые регулярно поступают нам с момента открутия лагеря. 
По факту угроз мы уже написали заявление в полицию. 
...
"""),
        ...
        npc.Owl.info(
            ...
            "данные."),
        npc.Owl.info(
            "К сожалению, смс-оповещения не самая безопасная вещь, поэтому вы можете установить на свои телефоны OTP "
            "Auth для iOS и andOTP для android - они сами связываются с сервисами и генерируют коды подтверждения."),
        ...
        npc.Owl.say(
            "К сожалению, разница есть. Пароль, который ты предложил, простой, потому что он плоностью состоит из "
        ...
        npc.Owl.info(
            ...
            "или специальную программу KeePass."),
        npc.Owl.say(
        ...
        npc.Owl.info(
            ...
            "программа мультиплатформная, вы можете поставить их на любые устройства с любой оперативной системой. "
            "Посмотрите, как много у нее вариантов! https://keepass.info/download.html - тут и для айфона, "
            "и для айпада есть!"),
        ...
        npc.Owl.info(
            ...
            "но и добавлять пароли других пользователей. Главное, что эта программа имеет открытый код и послностью "
            "бесплатна для вас!"),
    ...
    threat=[
        ...
        npc.Owl.info(
            ...
            "открытый код, и мы точно знаем, как именно он работет. Например, он точно-точно не собирает метаданные!"),
        npc.Owl.info(
