...
"""),
        ...
        #В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
        npc.Owl.info("Тогда можешь воспользоваться **генераторами паролей**. Сейчас их очень много, но лучше использовать те, которые точно не сохраняют ваши пароли на своих сервисах, например, https://www.random.org/passwords/ или специальную программу KeePass."),
        ...
        #В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
        npc.Owl.info("Запоминать ничего не нужно, для этого есть менеджеры паролей. Например, тот же самый KeePass. Эта программа мультиплатформная, вы можете поставить их на любые устройства с любой оперативной системой. Посмотрите, как много у нее вариантов! https://keepass.info/download.html - тут и для айфона, и для айпада есть!"),
