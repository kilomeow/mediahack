...
кто хочет открыть свою пасть, немедленно её заткнуть ради своей же безопасности.'''"""),
    ...
    threat=[
        ...
        npc.Magpie.say("'''Мы уже оперативно вычислили всех, кто сочувствует облезлому Сорокиному хвосту. Их имена и адреса установлены, их любимая газётенка даже не думала их спасать.'''"
