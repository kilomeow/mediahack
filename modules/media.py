...
кто хочет открыть свою пасть, немедленно её заткнуть ради своей же безопасности."""),
    ...
    vzlom_advice=[
        npc.Magpie.say("вот что пишут в канале Наш Дом:"),
        npc.Magpie.info("""
...
"""),
        ...
        npc.Owl.say(
            "К сожалению, разница есть. Пароль, который ты предложил, простой, потому что он полностью состоит из "
        ...
        npc.Owl.info(
            ...
            "программа мультиплатформенная, вы можете поставить её на любые устройства с любой операционной системой. "
