...
content = StoryMap(
    entry=[
        ...
        npc.Rabbit.say(
            ...
            "политике, но мы действительно хотели бы забыть эту историю."),
        npc.Floppa.say("А что с беженцами?"),
        npc.Rabbit.say("Мы перенаправим их в другие убежища. "),
        npc.Squirrel.say(
            "Мы удаляем опубликованные материалы. Но можем опубликовать ваш комментарий по поводу закрытия шелтера"),
    ...
    password=[
        ...
        npc.Owl.say("Так как SMS-сообщения можно перехватить, рекомендую вам установить на телефоны приложения "
                    "'''OTP '''Auth''' для iPhone и '''andOTP''' для Android. Когда вы привяжете свои аккаунты к этим "
        ...
        npc.Owl.say("Переходите по ссылке и следуйте инструкциям, это займёт 5 минут: [https://bit.ly/3tH5xiq]("
            "https://bit.ly/3tH5xiq)"),
        npc.Owl.say("Нажмите кнопку ниже, когда закончите."),
        ...
        # В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
        npc.Owl.info(
            "Если тебе сложно придумать пароль самой, можешь воспользоваться **генераторами паролей**. Сейчас их очень много, но лучше выбирать те, "
        ...
        npc.Owl.say(
            ...
            "на несколько сайтов. И отключите автозаполнение!"),
        npc.Floppa.say(
        ...
        npc.Owl.say(
            ...
            "помнит все твои пароли и вводит их автоматически. Тебе нужно запомнить только один пароль — от самого KeePass. "),
