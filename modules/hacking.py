...
#В СТРОКЕ НИЖЕ ДОЛЖНО БЫТЬ ГОЛОСОВАНИЕ
   npc.Squirrel.say("**ГОЛОСОВАНИЕ: Кролик взломан/Кролик не взломан**"),
...
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Owl.say("**[Установить двухфакторную аутентификацию]**"),
...
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Owl.say("Не очень. Зная тебя, даже Сорока сможет его подобрать. Попробуй лучше ja04[#lublu@kvas4](https://vk.com/im?sel=60840357&st=%23lublu%40kvas4)"),
...
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Owl.say("Тогда можешь воспользоваться **генераторами паролей**. Сейчас их очень много, но лучше использовать те, которые точно не сохраняют ваши пароли на своих сервисах, например, [https://www.random.org/passwords/](https://www.random.org/passwords/) или специальную программу KeePass."),
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
...
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Owl.say("Посмотрите, как много у нее вариантов! [https://keepass.info/download.html](https://keepass.info/download.html) - тут и для айфона, и для айпада есть! Кликните на эту ссылку, найдите версию для своего устройства и протестируйте! Нажмите на кнопку ниже, когда закончите."),
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Owl.say("**[Сделано!]**"),
...
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Owl.say("**[Получить корпоративный доступ]**"),
# ЗДЕСЬ     ****———————игроки жмут на кнопку———————
