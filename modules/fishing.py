...
content = StoryMap(
    entry=[
        ...
        npc.Owl.info(
            ...
            "своего кармана, но зато вы точно знаете, кто именно ответственен за ваше соединение, а во втором вы "
            "серьёзно рискуете своей безопасностью, связываясь с чужим сервером без всяких гарантий."),
        npc.Magpie.say("то есть если у меня нет денег то я остаюсь с голым хвостом?"),
        npc.Owl.info(
...
бригадир волк Евгений"""),
    ...
    letter=[
        ...
        npc.Floppa.say("Кажется, мы слишком много работаем"),
        ...
        npc.Owl.info(
            ...
            "настоящие, но в них могут быть опечатки в протоколах, доменах и названиях. Второе - это наличие "
...
Помните, Сорокин хвост опубликовал заявление какого-то парня из пожарной 
...
медведь Михаил Потапович"""),
        ...
        npc.Owl.say("Сегодня мы впервые столкнулись с фишингом, у людей он очень распространён. Фишинг это не просто "
                    "попытка украсть ваши данные ради шутки, это настоящее преступление, и в последнее время "
    ...
    ending3=[
        ...
        npc.Owl.say("Сегодня мы впервые столкнулись с фишингом, у людей он очень распространён. Фишинг это не "
                    "просто попытка украсть ваши данные ради шутки, это настоящее преступление, и в последнее время "
                    "преступники стали пользоваться более хитрыми схемами для хищения данных, а количество таких "
                    "преступлений растёт с каждым годом!"),
        npc.Owl.say("Надеюсь, теперь мы с вами будем ещё внимательнее!")
    ]
