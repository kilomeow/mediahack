...
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Squirrel.info("Хорошо! Тогда давайте все поставим себе символьные пароли и установим количество попыток! [Готово]"),
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
...
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Owl.info("Теперь вам нужно найти в настройках вашего устройства отключение уведомлений при заблокированном экране. [Готово]"),
...
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Owl.info("Тут примерно всё то же самое! Отключите биометрию, если есть, и поставьте пароли для ваших учётных записей! [Готово]"),
...
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Owl.info("Вот здесь есть инструкция к VeraCrypt - [https://securityinabox.org/ru/guide/veracrypt/linux/](https://securityinabox.org/ru/guide/veracrypt/linux/) [Понятно]"),
   npc.Magpie.say("а можно ли сделать что-то ещё?"),
#В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
   npc.Owl.info("Конечно! Вы дополнительно можете запаролить ваши папки, так к вашей важной информации будет ещё труднее добраться. Это особенно важно, если вы оставляете ваш ноут или комп без присмотра [Понятно]"),
...
#В СТРОКЕ НИЖЕ ДОЛЖНО БЫТЬ ГОЛОСОВАНИЕ
   npc.Squirrel.ask("Давайте решать вместе, стоит ли нам как изданию поддержать Кролика", [("Поддержать!", "support"), ("Не сообщаем", "not_support")], Var.support_rabbit),
