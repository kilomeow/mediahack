...
content = StoryMap(
    entry=[
        ...
        npc.Squirrel.info(
            "Хорошо! Тогда давайте все поставим себе символьные пароли и установим количество попыток!"),
        # В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
        npc.Owl.info("Отлично! Вы ведь запомнили свои пароли?"),
        npc.Owl.say(
        ...
        npc.Owl.info(
            ...
            "временной интервал, через который вы бы хотели сохраняться."),
        npc.Magpie.say("так"),
        ...
        npc.Owl.info(
            ...
            "если их вытащат из ваших телефонов."),
