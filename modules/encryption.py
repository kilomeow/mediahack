...
content = StoryMap(
    entry=[
        ...
        npc.Magpie.info(
            ...
            "миграции. Волки отобрали у него телефон и от его имени написали в чат редакции Сорокиного хвоста. Мы не знаем, "
        ...
        npc.Owl.info("Только не ставьте пароль 111111, я вас умоляю. "),
        ...
        npc.Squirrel.info(
            "Хорошо! Тогда давайте все поставим себе хорошие пароли!"),
        # В СТРОКЕ НИЖЕ ДОЛЖНА БЫТЬ КНОПКА
