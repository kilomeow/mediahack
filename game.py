...
def game_info(update, context):
    update.message.reply_text("Привет! Это игра *Взлом медиа*, которая познакомит вас с базовыми принципами информационной безопасности. "
"Взлом медиа — это кооперативная игра в телеграме, которая проводится силами меня и моих коллег-ботов. С ними вы познакомитесь когда начнете играть. \n\n"
...
def start_game(update, context):
    ...
    instructions.append("Убедитесь что <b>все с кем вы собираетесь играть</b> находятся в чате")
